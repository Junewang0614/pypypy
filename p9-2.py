...
the_restaurant2 = Restaurant('yidalicanting','yidali')
the_restaurant2.discribe_restaurant()

the_restaurant3 = Restaurant('xicanting','xi')
the_restaurant3.discribe_restaurant()
